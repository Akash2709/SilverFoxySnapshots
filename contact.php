...
<head>
    ...
    <title>SilverFoxy SnapShots - Contact</title>
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Message</strong> must cannot exceed 100 characters. \ \
                                                 </div>');
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Contact
                        <strong>SilverFoxy SnapShots</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-8">
                    <!--Map dalna hai-->
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d238075.0844727695!2d81.19764683002543!3d21.19520984012589!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a293cccec49ed45%3A0x2b3ff3bd73c91877!2sBhilai%2C%20Chhattisgarh!5e0!3m2!1sen!2sin!4v1617530097242!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
                <div class="col-md-4">
                    <p>Phone:
                        <strong>930-373-0451</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:rajnishad2799@gmail.com">rajnishad2799@gmail.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>Bhilai
                            <br>Chhattisgarh, India 490001</strong>
                    </p>
                </div>
